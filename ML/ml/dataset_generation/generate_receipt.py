"""
Generator for RECEIPT documents.
"""
import os, random
...
def generate_single_receipt(doc_id: str, config: dict, output_base_dir: str):
    template_num = random.randint(1, 10)
    template_id = f"receipt_template_{template_num:02d}"
    ...
    content = {
        ...
        "body_text": f"OFFICIAL STORE / TRANSACTION RECEIPT.\nPayment Method: Credit Card / Cash\nStatus: PAID IN FULL\nThank you for your purchase!"
    }

    rel_dir = os.path.join("RECEIPT", f"template_{template_num:03d}")
    ...
    gt_data = {"document_id": doc_id, "receipt_id": doc_id, "merchant_name": company, "customer_name": counterparty, "total_amount": total_amount}
