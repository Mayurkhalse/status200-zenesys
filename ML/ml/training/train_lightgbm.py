...
def main():
    ...
    params = train_config["hyperparameters"]["lightgbm"]
    print(f"Training LightGBM Classifier with params: {params}...")
    ...
    print(f"LightGBM Validation Accuracy: {acc:.4f}, Macro-F1: {macro_f1:.4f}")
    joblib.dump(model, paths["models"]["lightgbm_pkl"])
    print(f"Saved model to: {paths['models']['lightgbm_pkl']}")
